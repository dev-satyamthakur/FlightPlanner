...
// import { bearing } from "@turf/turf"; // No longer needed here
...
const PlanFlightCard = lazy(() => import("./components/PlanFlightCard"));
const FlightDetailsCard = lazy(() => import("./components/FlightDetailsCard"));
const FlightTipsCard = lazy(() => import("./components/FlightTipsCard"));
const GeneralTipsCard = lazy(() => import("./components/GeneralTipsCard"));
...
import { getSeatRecommendation } from "./utils/flightUtils"; // Import the function
...
// const getSeatRecommendation = (sourceLat, sourceLon, destLat, destLon) => { ... }; // Remove this function
